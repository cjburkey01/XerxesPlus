package com.cjburkey.burkeyspower.item;
...
public class ModItems {
	...
	public static void registerItems(RegistryEvent.Register<Item> e) {
		BurkeysPower.logger.info("Registering items for Burkey's Power");
		createItems();
	...
	public static void registerRenders(ModelRegistryEvent e) {
		BurkeysPower.logger.info("Registering item renders for Burkey's Power");
		for (Item item : items) {
	...
	private static Item createItem(Item item, String unlocName) {
		...
		item.setCreativeTab(tabBurkeysPower);
		items.add(item);
		return item;
	}
