...
public class TileEntityQuarry extends TileEntityInventory implements IEnergyStorage, ITickable {
    ...
    private static final int maxSkipsPerTick = 100;
    private static final int nearbyEntitySearchRadius = 1;
    ...
    public void readFromNBT(@Nonnull NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("itemsOnHold")) {
            workingOn.addAll(ItemHelper.getItemsFromTag("itemsOnHold", nbt));
        }
    }
